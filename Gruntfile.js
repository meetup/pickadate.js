        ...
        less: {
            ...
            themes: {
                files: {
					...
					'<%= dirs.themes.dest %>/pickadate.date.css': [ '<%= dirs.themes.src %>/base.less', '<%= dirs.themes.src %>/default.less', '<%= dirs.themes.src %>/base.date.less', '<%= dirs.themes.src %>/default.date.less' ]
                }
            }
        },
